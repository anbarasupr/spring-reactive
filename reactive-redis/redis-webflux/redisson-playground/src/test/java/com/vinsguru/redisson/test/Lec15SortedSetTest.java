...
public class Lec15SortedSetTest extends BaseTest {
    ...
    public void sortedSet(){
        ...
        Mono<Void> mono = sortedSet.addScore("sam", 12.25) // addScore will add the value to the exisitng score if sam exists else add new 
                .then(sortedSet.add(23.25, "mike")) //add will replace the score if mike exists  else add new
