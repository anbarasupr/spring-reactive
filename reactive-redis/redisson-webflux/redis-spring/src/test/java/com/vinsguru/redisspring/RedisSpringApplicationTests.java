...
class RedisSpringApplicationTests {
	...
	// takes 17 seconds for 500 K operation in reactive data library, 13 seconds in redission library
	@RepeatedTest(3)
	...
	// takes 10 seconds for 500 K operation in redission library using below
	@RepeatedTest(3)
	void redissonTest() {
